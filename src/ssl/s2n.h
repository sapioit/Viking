...
extern int s2n_config_set_nanoseconds_since_epoch_callback(struct s2n_config *config,
...
extern int s2n_config_add_cert_chain_and_key_with_status(struct s2n_config *config, char *cert_chain_pem,
                                                         char *private_key_pem, const uint8_t *status, uint32_t length);
